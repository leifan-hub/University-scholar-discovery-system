    ...
    <br>
     <div class="nav" style="text-align:center;display:block;background:#F8F8FF;background-size:cover;">
       <ul>
		...
		<li><a class="on" href="expert/getExpertByMajor"><font color="red" size="5"><b>专业</b></font></a></li>
	    ...
	    <input type="text" name="major" style="width:200px; height:40px;" placeholder="请输入专家专业领域"/> 
