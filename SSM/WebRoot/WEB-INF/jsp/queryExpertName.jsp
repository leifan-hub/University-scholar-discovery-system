...
<html>
  ...
  <body style="background:#FFFFF4">
      <div id="div1" style="text-align:center;" bgcolor="#FFFFF4">
    <img id="image"src="images/query.jpg" width="100" height="100" style="vertical-align:middle" > 
    <font style="FONT-FAMILY:华文行楷" size=6>按名字进行查询 </font>
  ...
  <nav class="navbar navbar-default" role="navigation">
    ...
    <form action="expert/getExpertByName"  method="post" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'"bgcolor = "#FFFFF4" >
    	搜索专家姓名：<input type="text" name="name" />
    	<br>
