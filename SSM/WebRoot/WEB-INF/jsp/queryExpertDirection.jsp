...
<style>
  ...
  <body style="background:#FFFFF4">
    ...
    <font style="FONT-FAMILY:华文行楷" size=6>按研究方向进行查询 </font>
  	</div>
    <br>
    <br>
    <br>
    <br>
     <div class="nav" style="text-align:center;display:block;background:#F8F8FF;background-size:cover;">
       <ul>
		...
		<li><a class="on" href="expert/getExpertByResearchDirection"><font color="red" size="5"><b>研究领域</b></font></a></li>
		<li style="margin-left:50px;">
		<form action="expert/getExpertByResearchDirection"  method="post" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'">    
	    <input type="text" name="research_direction" style="width:200px; height:40px;" placeholder="请输入专家研究方向"/> 
