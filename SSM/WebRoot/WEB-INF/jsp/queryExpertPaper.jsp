...
<html>
  ...
  <body style="background:url(images/bggif.gif); background-size: cover;">
    ...
    <font style="FONT-FAMILY:华文行楷" size=8>按论文进行查询 </font>
  </div>
    <br>
    <br>
    <br>
    <br>
     <div class="nav" style="text-align:center;display:block;background:#EEEEEE;background-size:cover;">
       <ul>
		...
		<li><a class="on" href="expert/getExpertByPaper"><font color="#856363" size="5"><b>论文</b></font></a></li>
		<li><a href="expert/getExpertByResearchDirection"><font color="#856363" size="5"><b>研究领域</b></font></a></li>
		<li style="margin-left:50px;">
		<form action="expert/getExpertByPaper"  method="post" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'">    
	    <input type="text" name="paper" style="width:200px; height:40px;vertical-align: top;" placeholder="请输入专家论文"/> 
