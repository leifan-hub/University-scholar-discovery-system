...
<style>
  ...
  <body style="background:#FFFFF4">
    ...
    <font style="FONT-FAMILY:华文行楷" size=6>按论文进行查询 </font>
  </div>
    <br>
    <br>
    <br>
    <br>
     <div class="nav" style="text-align:center;display:block;background:#F8F8FF;background-size:cover;">
       <ul>
		...
		<li><a class="on" href="expert/getExpertByPaper"><font color="red" size="5"><b>论文</b></font></a></li>
	    ...
	    <input type="text" name="paper" style="width:200px; height:40px;" placeholder="请输入专家论文"/> 
